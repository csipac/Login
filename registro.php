	...
	if (!empty($_POST)) {
		...
		if (count($errors) == 0) {
			...
			if ($arr['success']) {
				...
				//------------------------------- LLAMAR FUNCION PARA REGISTRAR USUARIO -----------------------------//
				...
				if ($registro > 0) {
					...
					el proceso de registro, es indispensable dar click en
					el siguiente enlace <a href='$url'>Activar Cuenta </a>";

					if (enviarEmail($email, $nombre, $asunto, $cuerpo)) {
						echo "Para terminar el proceso de registro siga las
						instrucciones que le hemos enviado a su correo electronico: $email";
					...
					<div class="panel-body" >
						...
						<form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
							...
							<div class="form-group">
								...
								<div class="g-recaptcha col-md-9" data-sitekey="6LdyNCEUAAAAAHlVTMOMdX3XOpduQE1tG5-W_XXH"></div>
							</div>
